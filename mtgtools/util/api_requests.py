...
scryfall_card_search_url = (
    "https://api.scryfall.com/cards/search?include_extras=true&order=set&page={}&q=e%3A{}&unique=prints"
)
    ...
    for current_set in sets:
        card_page_uris.extend(
            [
                ...
                for page in range(1, int(math.ceil(current_set.card_count / 175)) + 1)
            ]
        )
    loop = asyncio.new_event_loop()
    asyncio.set_event_loop(loop)
